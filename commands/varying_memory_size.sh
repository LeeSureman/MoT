...
for dataset in anli_a1 anli_a2 anli_a3
do
for demo_sample_p in 0.1 0.2 0.4 0.6 0.8 1
do
...
python -u run_inference_retrieval_m_size_analysis.py \
--demo_sample_p $demo_sample_p \
