exp_tag=new_self_consistency_2
for demo_seed in 5
do
#for dataset in drop aqua anli_a1 anli_a2 anli_a3 boolq qa_wikidata fact_checker openbookqa com_v
for dataset in openbookqa boolq qa_wikidata fact_checker com_v anli_a3
do
for entropy_threshold in 0.3
do
for self_consistency_paths in 8
do
